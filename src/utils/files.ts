...
import license from '../assets/documents/Ліцензія.pdf';
import statut from '../assets/documents/Статут закладу освіти.pdf';
import schoolServiceTerritory from '../assets/documents/Територія обслуговування школи.pdf';
import sessionDecision from '../assets/documents/Рішення сесії.pdf'
